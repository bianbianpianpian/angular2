System.register(['angular2/core', './student'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            StudentFormComponent = (function () {
                function StudentFormComponent() {
                    this.names = ['马云', '马化腾', '刘强东', '周鸿祎'];
                    this.model = new student_1.Student(1880, this.names[0], 25, "北京市花神街39号");
